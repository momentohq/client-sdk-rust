...
///
/// let set_request = SetIfPresentAndNotEqualRequest::new(
///     &cache_name,
///     "key",
///     "new-value",
///     "cached-value"
...
/// # }
/// ```
pub struct SetIfPresentAndNotEqualRequest<K: IntoBytes, V: IntoBytes, E: IntoBytes> {
    cache_name: String,
    key: K,
    value: V,
    not_equal: E,
...
impl<K: IntoBytes, V: IntoBytes, E: IntoBytes> SetIfPresentAndNotEqualRequest<K, V, E> {
    /// Constructs a new SetIfPresentAndNotEqualRequest.
